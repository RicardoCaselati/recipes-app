  ...
  return (
    <div>
      ...
      <div className="d-flex justify-content-around" style={ { marginTop: '25px' } }>
        <h1 id={ styles.recipeTitle } data-testid="recipe-title">
      ...
      <div className="container-fluid">
        ...
        <ol id={ styles.bodyDescription } data-testid="recipe-category">
      ...
      <div className="container-fluid">
        <h5 style={ { marginTop: '30px' } } id={ styles.sectionTitle }>
          Instructions
        </h5>
        <p
      ...
      <div className="d-flex justify-content-center my-2 container-fluid">
        <button
          id={ styles.btn }
          type="button"
